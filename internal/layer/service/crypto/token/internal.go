...
func (m *managerImpl) validateToken(token string, secret string, tokenType string) (jwt.MapClaims, error) {
...
func (m *managerImpl) validateClaims(claims jwt.MapClaims, checkJTI bool) error {
	// Get the JWT ID.
...
func (m *managerImpl) validateAudience(aud string) error {
	if aud != m.audience {
...
func (m *managerImpl) validateIssuer(iss string) error {
	if iss != m.issuer {
...
func (m *managerImpl) validateAzp(azp string) error {
